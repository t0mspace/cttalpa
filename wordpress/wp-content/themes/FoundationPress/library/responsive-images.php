...
// add_image_size( 'featured-small', 640, 400, true ); // name, width, height, crop
// add_image_size( 'featured-medium', 640, 450, false );
...
// add_image_size( 'featured-small', 840,400, true ); // name, width, height, crop
// // add_image_size( 'featured-medium', 1280, 500, false );
// add_image_size( 'featured-large', 1200, 400, true );
// add_image_size( 'featured-xlarge', 1920, 400, true );
// add_image_size( 'featured-medium', 1200, 800, false);
add_image_size( 'slideshow', 840, 400, array( 'left', 'top' ) );
add_image_size( 'posts-home', 750);
add_image_size( 'sponsors', 200);


// Add additional image sizes
// add_image_size( 'fp-small', 640);
// 
add_image_size( 'fp-small', 400);
add_image_size( 'fp-medium', 500);//for the posts in the home page
