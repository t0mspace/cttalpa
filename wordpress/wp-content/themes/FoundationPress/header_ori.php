            ...
            <div class="large-12 columns">
                <nav class="align-center" id="top-menu">
                    <ul class="menu align-right">
                        <li><a href="https://www.facebook.com/groups/cttroyalalpaschaerbeekwoluwe/?fref=nf"><i class="fa fa-facebook-official" aria-hidden="true"></i></a></li>
                        <li><a href="https://twitter.com/cttalpa"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                    </ul>
                </nav>
...
<!--                        <button class="menu-icon large" type="button" data-toggle="offCanvas">-->
<!--                        </button>-->
                    </a>
